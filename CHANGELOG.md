...
### Fixed
- Server no longer crashes when `cards` directory is missing
- Automatically creates `cards` directory on startup if it doesn't exist
- Logs a warning with instructions for mounting a volume for persistent card storage
